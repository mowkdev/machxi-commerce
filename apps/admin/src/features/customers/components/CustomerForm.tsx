          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <CardDescription>
                  Manage customer shipping and billing addresses. Only one
                  address can be default for each type.
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-4">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  This removes the saved address from the
                                  customer profile.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
            ...
            {isAddressFormOpen ? (
              <div className="rounded-lg border p-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <Field>
                    <FieldLabel htmlFor="address-first-name">
                      First name
                    </FieldLabel>
                    <Input
                  ...
                  <Field>
                    <FieldLabel htmlFor="address-last-name">
                      Last name
                    </FieldLabel>
                    <Input
                  ...
                  <Field className="flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Use this as the customer&apos;s primary shipping
                        address.
                      </p>
                    </div>
                    <Switch
      ...
      {!isCreateMode && initialData ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Deleting a customer unlinks related addresses, carts, orders, and
